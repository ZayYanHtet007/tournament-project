...
<style>
    :root {
        ...
        --cyber-blue: #00f2ff;
        --cyber-blue-glow: rgba(0, 242, 255, 0.5);
        --riot-bg: #0f1923;
        --riot-white: #ece8e1;
        --riot-border: rgba(0, 242, 255, 0.15);
        --gaming-dark: #080a0c; 
    }
    ...
    .profile-wrapper::before {
        ...
        background: 
            radial-gradient(circle at var(--mouse-x, 50%) var(--mouse-y, 50%), 
                        ...
                        transparent 60%),
            radial-gradient(circle at 0% 0%, rgba(0, 150, 255, 0.1) 0%, transparent 50%),
            radial-gradient(circle at 50% 50%, rgba(0, 242, 255, 0.1) 0%, transparent 50%);
        z-index: 0;
        pointer-events: none;
    }

    /* Animated Scanline - Blue Tint */
